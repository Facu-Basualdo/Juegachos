...
- `src/games/imitame.ts` — `ImitameSim`: Imitame (clon de Mimic Party). Sortea el sonido
  ...
  el server reenvia todas las tomas a todos. Decide la ruleta (bonus a la mitad de abajo de
