...
| Teléfono Cortado | Party | El clásico teléfono descompuesto, pero con dibujos: escribís una frase, te toca dibujar la que escribió otro, y después tenés que adivinar qué quiso decir un tercero con su dibujo. Sumás puntos por acertar rápido y también cuando alguien entiende lo que dibujaste; al final se revelan las cadenas enteras para ver dónde se deformó todo. Solo se juega en salas con amigos. | [Ari](https://github.com/MissedSalmon) |
| Macaco Tilt | Precisión | Un mono haciendo equilibrio sobre un tablón de bambú apoyado en una cuña, arriba de un barranco. Caminás para un lado y para el otro para reacomodar el peso, pero cada vez que te movés inclinás más la tabla y la gravedad te arrastra al borde. Cada tantos segundos se parte un pedazo del tablón y te quedás con menos piso, y de repente entra una ráfaga de viento que te descoloca todo. Aguantá lo máximo que puedas. | [emi1i0](https://github.com/emi1i0) |
| La Escalera | Reflejos | Un obrero atrapado en una escalera mecánica que baja hacia un pozo de púas: un cartel de arriba te pide una flecha por vez y cada acierto te gana un escalón, mientras la cinta te arrastra sin parar hacia el fondo. Errar o dejar vencer la flecha te hace resbalar, y la máquina tira cada vez más fuerte; tu marca son los escalones que ganás antes de caer. | [matiasgzlez](https://github.com/matiasgzlez) |
| Templo Rodante | Reflejos | Estás atrapado en una cámara de piedra de un templo enterrado y por los dos extremos vienen rodando vigas erizadas de púas. Las rasantes, al rojo vivo, las saltás; las altas, de hueso pálido, las esquivás agachándote. La única pista confiable es la sombra: la rasante la lleva pegada, la alta la deja despegada en el piso. Cada vez vienen más rápido y más seguido, y a veces te entran dos a la vez, una por cada lado. En salas corren todos en la misma cámara, con las mismas vigas, y se ven saltar y agacharse en vivo. | [Facu-Basualdo](https://github.com/Facu-Basualdo) |
| Manchón | Party | Captura la zona a los brochazos: sos un pincel suelto sobre una hoja de papel y vas pintando cada celda por la que pasás, robándole las que ya eran de otro. Tenés un salpicón con enfriamiento que pinta un círculo grande y deja aturdido un rato al que agarre adentro, así que no alcanza con correr: hay que ir a sacarle el territorio a los demás. A los 45 segundos gana el que se quedó con más tablero. Solo se juega en salas con amigos. | [Facu-Basualdo](https://github.com/Facu-Basualdo) |
| Birome | Arcade | Sos la punta de una birome que cruza sola una hoja cuadriculada: mantené apretado para subir en diagonal, soltá para bajar y colate entre los tachones y los manchones de tinta sin tocar los márgenes rojos. Cada vez va más rápido. En salas corren todos el mismo recorrido y ves las rayas de los demás en vivo. | [Facu-Basualdo](https://github.com/Facu-Basualdo) |
| Patas Largas | Arcade | Una criatura de cabeza cúbica y patas absurdamente largas cruzando la duna al amanecer, al estilo Daddy Long Legs. Un toque adelanta una pata y las patas alternan siempre, izquierda y derecha, sin excepción, y cuanto más mantenés apretado más larga sale la trancada: el resto lo hace la gravedad, porque el cuerpo bascula sobre el pie apoyado y vos elegís cuándo cortarle la caída. Si tocás apurado la pata queda corta, si tardás el cuerpo ya se te fue de largo y se te abren las gambas; que toque el suelo cualquier cosa que no sean los zapatos y se termina la caminata. Tu marca son los metros. | [emi1i0](https://github.com/emi1i0) |
| Imitame | Party | Suena un sonido una sola vez (un gato, una sirena, un ta-ta-ta-taaa) y todos lo imitan a la vez con la voz: tenés una sola toma. El jurado mide la melodía, el ritmo y los golpes, no si cantás lindo. Después las tomas suenan una por una para toda la sala y una ruleta reparte puntos dobles y sabotajes para la ronda siguiente: eco, voz de helio, saturado o tu toma cambiada por un pedo. Inspirado en Mimic Party. Solo se juega en salas con amigos y pide micrófono. | [matiasgzlez](https://github.com/matiasgzlez) |
...
| Pista Loca | Party | Una pista de baile de bloques de colores colgada en la nada, al estilo Block Party. Mientras suena la música bailás; cuando se corta, se pide un color y tenés unos segundos para pararte encima antes de que se caiga todo lo demás, y si te agarran cerca te pueden empujar al vacío. Cada ronda hay menos tiempo. Gana el último en pie. Solo en salas. | [matiasgzlez](https://github.com/matiasgzlez) |
| Marea de Lava | Party | Una pared de roca llena de salientes y la lava subiendo desde abajo, cada vez más rápido. Trepá saltando de plataforma en plataforma antes de que te alcance: gana el que llega más alto. Solo en salas. | [matiasgzlez](https://github.com/matiasgzlez) |
| Dalgona | Precisión | La prueba de la galleta de azúcar del Juego del Calamar. Elegís una lata a ciegas y te toca un círculo, un triángulo, una estrella o el temido paraguas. Sacá la figura del caramelo con la aguja sin que se parta: si vas rápido o te salís de la línea, cruje, y el mango del paraguas es lo primero que se rompe. Lamela para ablandarla. Solo o en salas. | [matiasgzlez](https://github.com/matiasgzlez) |
| La Cuerda | Party | Un puente angosto sobre el vacío y dos cuerdas gigantes que giran cada vez más rápido, cada una para su lado. Saltalas en el momento justo, no te caigas por el tramo roto y cuidate de los empujones: gana el que llega más lejos. Solo en salas. | [Facu-Basualdo](https://github.com/Facu-Basualdo) |
