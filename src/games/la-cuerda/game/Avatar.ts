...
/** Pieles y pelos neutros (DESIGN.md: la remera es el unico color personal; el pantalon es el del jogging verde agua de todos). */
...
const BODY_H = 0.72;
const HEAD = 0.46;
/** Duracion de la animacion del empujon (s). */
...
export class Avatar {
  ...
  /** Empujon: los dos brazos al frente de golpe y vuelven (el de Pista Loca). */
  push(): void {
