/**
 * Input de La Cuerda (el de Marea de Lava, con camara en tercera persona).
 *
 * - Compu: WASD / flechas para correr (relativo a donde mira la camara), ESPACIO
 *   para saltar, F para empujar y el MOUSE para mirar: un clic lo captura (pointer lock, como en
 ...
 *   mitad derecha gira la camara, y los botones EMPUJAR y SALTAR van abajo a la
 *   derecha (los maneja el Hud y llaman a `requestPush` / `requestJump`).
 *
...
export class InputController {
  ...
  private onKeyDown = (e: KeyboardEvent): void => {
    ...
    // F empuja (el clic no: aca captura el mouse para mirar).
  ...
  private onPointerDown = (e: PointerEvent): void => {
    ...
    if (el?.closest(".lc-controls, .lc__card, .leaderboard")) return;
