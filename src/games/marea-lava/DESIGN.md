...
Es una pared de roca que sube hacia la oscuridad y una marea de lava que la persigue. Mientras trepa, la camara va detras del escalador, en tercera persona como en Minecraft, para que la profundidad de cada salto se lea; al quedar afuera se mira la pared de frente, como desde el vacio: una cara ancha de basalto al fondo, y delante, salientes de piedra a distintas profundidades por donde se trepa. La composicion es vertical y tiene una sola direccion: arriba es la salvacion, abajo es la muerte, y la pantalla lo dice sin palabras porque la luz sale de abajo.
