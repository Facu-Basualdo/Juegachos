/**
 * Input de Luz Roja, Luz Verde (copiado del de Derrumbe, sin el salto).
 *
 * - Compu: WASD / flechas para correr.
 * - Celu: un dedo en cualquier lado es un joystick flotante (aparece donde apoyas).
 *   Soltar el dedo es frenar, que es exactamente lo que pide la luz roja.
 *
 * La camara es fija, asi que la direccion de pantalla es la direccion del mundo.
 *
...
export class InputController {
  ...
  private onPointerDown = (e: PointerEvent): void => {
    ...
    if (el?.closest(".lr__card, .leaderboard")) return;
