...
export const meta: GameEntry = {
   ...
   * duracion: 45s de partida + el congelado inicial + la espera del roster dan
   * ~60s, y el deadline de la sala ya suma 10s de navegacion. Se muestra en el
   * briefing, asi que tampoco conviene inflarlo: al lado de la descripcion, que
   * dice los 45 segundos, un tope muy alto se lee como si la partida durara eso.
   */
  roomTimeLimitSec: 75,
};
